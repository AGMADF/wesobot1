...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = [' $help',`Im on ${client.guilds.size} servers`,`i help ${client.users.size} Members`,' Aqua Community ','-help'];
    var i = -1;
    var j = 0;
...
client.on('message', message => {
  ...
  message.channel.send("**:https://discordapp.com/api/oauth2/authorize?client_id=700987908596957214&permissions=8&scope=bot:.تم ارسال الرابط برسالة خاصة**")
...
『-obc ====> لارسال رسالة اونلاين 
『-ebc ====> لارسال رسالة مع امبد
